# -*- coding: utf-8 -*-
"""
Created on Thu Apr 14 14:22:41 2022
...
print('poly7Const = ', reg2.intercept_)
print('poly7Coef = ', reg2.coef_)
...
plt.title("day 2 actual vs. polynomial regression order 7 prediction")
plt.xlabel("index")
plt.ylabel("load (kWh)")
