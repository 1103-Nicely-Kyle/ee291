# -*- coding: utf-8 -*-
"""
Created on Thu Apr 14 14:01:08 2022
...
print('poly3Const = ', reg2.intercept_)
print('poly3Coef = ', reg2.coef_)
...
plt.title("day 2 actual vs. polynomial regression order 3 prediction")
plt.xlabel("index")
plt.ylabel("load (kWh)")
